...
export class FumolaState {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        FumolaStateFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_fumolastate_free(ptr, 0);
    }
    /**
    ...
    eval(source) {
        ...
        try {
            ...
            const ret = wasm.fumolastate_eval(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
    ...
    constructor() {
        const ret = wasm.fumolastate_new();
        this.__wbg_ptr = ret >>> 0;
        FumolaStateFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     * @returns {string}
     */
    setModule(local_path, content) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(local_path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.fumolastate_setModule(this.__wbg_ptr, ptr0, len0, ptr1, len1);
            deferred3_0 = ret[0];
            deferred3_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
if (Symbol.dispose) FumolaState.prototype[Symbol.dispose] = FumolaState.prototype.free;
 ...
 * @returns {string}
 */
export function evalString(source) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.evalString(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
const FumolaStateFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_fumolastate_free(ptr >>> 0, 1));
